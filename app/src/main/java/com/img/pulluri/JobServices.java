...
public class JobServices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = JobServices.this;
        arrayList = new ArrayList<String>();

        arrayList.add(Constants.Job_Service);
        arrayList.add(Constants.Job_Service1);
        arrayList.add(Constants.Job_Service2);
