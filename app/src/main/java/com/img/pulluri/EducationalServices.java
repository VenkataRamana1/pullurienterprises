...
public class EducationalServices extends AppCompatActivity {
    private static final  String TAG="EducationalServices";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_educational_services);
        mContext = EducationalServices.this;
        arrayList = new ArrayList<String>();

        arrayList.add(Constants.Admissions_for_Students);
